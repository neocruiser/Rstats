...
1. There is multiple levels for host resistance and many more levels for pathogen virulence
...
5. Hypothesis 4: The gene-for-gene concept associates every host resistance gene with a pathogen avirulence gene
...
11. Differential distribution of SNPs and indels were found between strains.
12. Preferential substitution of SNPs were found between strains.
13. Furthermore, contigs were annotated with Pfam domains.
14. Differential distribution of SNPs inside and outside domains were investigated.
15. Higher number of variants were found in salinity genes than in virulence genes
...
18. Low genetic variation (low diversity) in virulence genes can be linked to a low spread (low disease incidence) of QPX in a demographic region or a susceptible host. (comparison between NY, VA, and MA)
