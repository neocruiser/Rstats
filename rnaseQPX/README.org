...
19. Low genetic variation (low diversity) in virulence genes can be linked to a low spread (low disease incidence) of QPX in a demographic region or a susceptible host. (comparison between NY, VA, and MA)
