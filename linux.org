...
* INSTALL EMACS 24
Latest version [[http://git.savannah.gnu.org/cgit/emacs.git/tree/][on git]] and how to build it on linux from [[http://ergoemacs.org/emacs/building_emacs_on_linux.html][ergoemacs]]. When installing on =eOS Freya= get emacs from the Software Market and install the one with =Lucid= style for it to work in version 24.
#+BEGIN_SRC shell
sudo apt-get install build-essential
sudo apt-get build-dep emacs24
wget http://gnu.mirror.vexxhost.com/emacs/emacs-24.5.tar.gz
