...
conda install -c bioconda numpy=1.7.1 scipy=0.12.0 scikit-learn=0.13.1 matplotlib=1.2.1
source deactivate
conda env remove --name $virt_env
...
#+END_SRC
* Docker
Setup docker on Arch. Initialize the docker daemon. 
Create a group called docker. Add current user to the group.
#+BEGIN_SRC shell
...
docker container stop $ID_test
docker login
docker tag $test neocruiser/$test:v0.0.1
docker push neocruiser/$test:v0.0.1
docker run -d -p 4000:80 neocruiser/$test:v0.0.1
## create a swarm service
cat > docker-compose.yml
docker swarm init
docker swarm join
docker stack deploy -c <composefile> $tasks
docker service ls
docker service ps $tasks
docker stack rm $tasks
docker swarm leave -f
## create a swarms
pamac install virtualbox
docker run -p 80:80 username/repo:tag
dockr-machine create --driver virtualbox dev
docker-machine env dev
eval $(docker-machine env -u)
docker-machine ssh dev free -m
docker-machine ssh dev df -h
docker-machine ssh dev "docker swarm init --advertise-addr <myvm1_IP>"
docker node ls
docker-machine ls
docker stack deploy <compose> $app
docker service ps $app
docker stack rm $app
docker-machine stop $(docker-machine ls -q)
## if private repo
docker login <registry>
docker stack deploy --with-registry-auth -c <compose> $app
#+END_SRC
* Ruby for Jekyll
...
[[https://www.tutorialdocs.com/article/git-basic-command-list.html][Comprehensive list]] of most common GITHUB commands
...
| *ripgrep*             |                                                              | [[https://github.com/BurntSushi/ripgrep#installation][github]]                                     |
| sublime-merge         | sudo apt-get install sublime-merge                           | github GUI                                 |
| Lepton                |                                                              | [[https://github.com/hackjutsu/Lepton/releases][github]]                                     |
| haxor-news            | sudo pip install haxor-news                                  | [[https://github.com/donnemartin/haxor-news][github]] CLI for hacker news                 |
| tmux-manager          |                                                              | [[https://github.com/tmux-plugins/tpm][github]] CTRL+B+I (fetch plugin)             |
| tmux-resurrect        |                                                              | [[https://github.com/tmux-plugins/tmux-resurrect][github]]                                     |
| tmux-contnuum         |                                                              | [[https://github.com/tmux-plugins/tmux-continuum][github]]                                     |
| ranger                |                                                              | [[https://github.com/ranger/ranger][github]] file manager                        |
| nteract               |                                                              | [[https://nteract.io/kernels/r][website]] notebook reader                    |
| jq                    |                                                              | [[https://stedolan.github.io/jq/][CLI for JSON]]                               |
| rq                    |                                                              | [[https://github.com/dflemstr/rq][CLI for JSON]]                               |
| retext                |                                                              | [[https://github.com/retext-project/retext][github]] for markdown WYSWYG                 |
| rofi                  |                                                              | [[https://github.com/DaveDavenport/rofi][github]] window switcher                     |
| NZBget                | wget https://nzbget.net/download/nzbget-latest-bin-linux.run | [[https://nzbget.net/][Home]]                                       |
|                       | sh nzbget-latest-bin-linux.run                               | [[https://nzbget.net/][Home]]                                       |
|                       | ./nzbget -D                                                  |                                            |
| jsonsmash (JSON)      |                                                              | [[https://www.npmjs.com/package/jsonsmash][Link]]                                       |
| catj (JSON)           |                                                              | [[https://github.com/soheilpro/catj][Link]]                                       |
| fzf                   | pamac install fzf                                            | fuzzy searcher                             |
| fd                    | pamac install fd                                             | replaces find                              |
| zsh-autosuggestions   | pamac install zsh-autosuggestions                            | [[https://github.com/zsh-users/zsh-autosuggestions/blob/master/INSTALL.md#arch-linux][Github]]                                     |
| nmon                  | pamac install nmon                                           | Alternative to htop                        |
| zplug                 |                                                              | [[https://github.com/zplug/zplug][Github]]                                     |
|                       |                                                              |                                            |
...
## device (e.g. /dev/sdb), and not the partition number (e.g. /dev/sdb1)
