...
<<blast1>>=
blast <- read.xlsx("./data/blast.xlsx", sheetIndex = 1)
blast <- gather(blast[, -c(13:14)], "options", "counts", 4:12)
ggplot(blast,
       aes(x = sample,
           y = counts,
           fill = options)) + 
...
<<interpro1>>=
interpro <- read.xlsx("./data/interpro.xlsx", sheetIndex = 1)
interpro <- gather(interpro, "filters", "value", 2:5)
head(interpro)
ggplot(interpro,
       aes(x = sample,
           y = value,
...
interpro <- read.xlsx("./data/interpro.xlsx", sheetIndex = 2)
interpro <- gather(interpro, "filters", "value", 3:7)
head(interpro)
ggplot(interpro, 
       aes(x = database,
           y = value,
