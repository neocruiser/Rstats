...
Interaction network can be constructed from publicly available databases comprising of protein–protein interactions (KEGG, STRING, BioGRID) and genetic interactions (TRANSFAC).
