...
Extract clam contigs with max 4 gaps and at least 450 nucleotides aligned to reference for any of the blocks. These contigs are then mapped to QPX contigs. The common in both lists are considered than as clam genes.
#+BEGIN_SRC shell
