#+TITLE: Network analysis of dual RNA-Seq reveals a conserved repertoire of virulence and survival mechanisms in the protistan parasite QPX
...
*** BLAT
Blat is found also on xsede. [[http://genome.ucsc.edu/goldenPath/help/blatSpec.html][Documentation]] and [[http://hgdownload.cse.ucsc.edu/admin/exe/linux.x86_64/blat/][Blat linux packages]]
Installation.
#+BEGIN_SRC shell
