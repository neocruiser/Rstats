...
<<normalized3,out.width='.5\\linewidth'>>=
...
<<normalized4,out.width='.5\\linewidth'>>=
...
<<normalized5,out.width='.5\\linewidth'>>=
...
\smallskip
\begin{enumerate}
\item Clonorchis sinensis
\item Opisthorchis viverrini
\item Schistosoma haematobium
\item Schistosoma japonicum
\item Schistosoma mansoni
\end{enumerate}

\smallskip
All previous genomes, fasta files, and some annotations can be found at \href{http://trematode.net/TN_frontpage.cgi?navbar_selection=home&subnav_selection=home_splash_page}{NCBI}.
...
rbind(p1,p3,p4) %>%
    ...
    facet_wrap(~ V1 + V3 + V5,
               ncol = 6,
               scales = "free") +
    labs(x = "Worm parasites assembled transcriptomes",
