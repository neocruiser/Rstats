...
\subsection{Machine learning classifiers selected}
\label{subsec:models}
...
\begin{table}[h]
  ...
  \begin{tabular}{l p{6.2cm} l p{4.5cm} l}
    ...
    4 & C5.0 & \href{https://cran.r-project.org/web/packages/C50/index.html}{C50} & trials, model, winnow & C5.0 \\
    5 & Random forest & \href{https://cran.r-project.org/web/packages/randomForest/index.html}{randomForest} & mtry & rf \\
    6 & Regularized random forest & \href{https://cran.r-project.org/web/packages/RRF/index.html}{RRF} & mtry, coefReg, coefImp & RRF \\
    ...
    22 & Deep NN with \href{https://arxiv.org/pdf/1412.6980.pdf}{Adam} optimization & \href{https://mxnet.incubator.apache.org/}{mxnet} & layer1, layer2, layer3, dropout, beta1, beta2, learningrate, activation & mxnetAdam \\
    23 & Stacked autoencoder deep NN & \href{https://cran.r-project.org/web/packages/deepnet/}{deepnet} & layer1, layer2, layer3, hidden\_dropout, visible\_dropout & dnn \\
  ...
  \caption*{
    ...
    $^{\dagger}$Parameters are crucial to optimize for accuracy. Similar models have different parameters. 
